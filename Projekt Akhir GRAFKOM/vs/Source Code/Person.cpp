...
void Person::BuildHead() {
	...
	float vertices[] = {
		...
		// front
		-0.5, -0.5, 0.5, 8.0/64.0, 48.0/64.0, 0.0f,  0.0f,  1.0f, // 0  Kiri Bawah
		0.5, -0.5, 0.5, 16.0/64.0, 48.0/64.0, 0.0f,  0.0f,  1.0f, // 1	Kanan Bawah
		0.5,  0.5, 0.5, 16.0/64.0, 56.0/64.0, 0.0f,  0.0f,  1.0f, // 2	Kanan Atas
		-0.5,  0.5, 0.5, 8.0/64.0, 56.0/64.0, 0.0f,  0.0f,  1.0f, // 3	Kiri Atas

		// right
		0.5,  0.5,  0.5, 16.0/64.0, 56.0/64, 1.0f,  0.0f,  0.0f, // 4   Depan Atas
		0.5,  0.5, -0.5, 24.0/64.0, 56.0/64, 1.0f,  0.0f,  0.0f, // 5	Belakang Bawah
		0.5, -0.5, -0.5, 24.0/64.0, 48.0/64, 1.0f,  0.0f,  0.0f, // 6	Belakang Atas
		0.5, -0.5,  0.5, 16.0/64.0, 48.0/64, 1.0f,  0.0f,  0.0f, // 7	Depan Atas

		// back
		-0.5, -0.5, -0.5, 32.0/64.0, 48.0 /64, 0.0f,  0.0f,  -1.0f, // 8 
		0.5,  -0.5, -0.5, 24.0/64.0, 48.0 /64, 0.0f,  0.0f,  -1.0f, // 9
		0.5,   0.5, -0.5, 24.0/64.0, 56.0 /64, 0.0f,  0.0f,  -1.0f, // 10
		-0.5,  0.5, -0.5, 32.0/64.0, 56.0 /64, 0.0f,  0.0f,  -1.0f, // 11

		// left
		-0.5, -0.5, -0.5,  0.0/64.0, 48.0/64.0, -1.0f,  0.0f,  0.0f, // 12 Depan Atas
		-0.5, -0.5,  0.5,  8.0/64.0, 48.0/64.0, -1.0f,  0.0f,  0.0f, // 13 Belakang Bawah
		-0.5,  0.5,  0.5,  8.0/64.0, 56.0/64.0, -1.0f,  0.0f,  0.0f, // 14 Belakang Atas
		-0.5,  0.5, -0.5,  0.0/64.0, 56.0/64.0, -1.0f,  0.0f,  0.0f, // 15 Depan Atas

		// upper
		 0.5, 0.5,  0.5,  8.0/64.0, 48.0/64.0,   0.0f,  1.0f,  0.0f, // 16 Kiri Depan
		-0.5, 0.5,  0.5, 16.0/64.0, 48.0/64.0,   0.0f,  1.0f,  0.0f, // 17 Kanan Depan
		-0.5, 0.5, -0.5, 16.0/64.0, 56.0/64.0,  0.0f,  1.0f,  0.0f, // 18 Kanan Belakang
		 0.5, 0.5, -0.5,  8.0/64.0, 56.0/64.0,   0.0f,  1.0f,  0.0f, // 19 Kiri Belakang

		// bottom
		-0.5, -0.5, -0.5, 16.0/64.0, 64.0/64,  0.0f,  -1.0f,  0.0f, // 20 Kiri Depan
		 0.5, -0.5, -0.5, 24.0/64.0, 64.0/64,  0.0f,  -1.0f,  0.0f, // 21 Kanan Depan
		 0.5, -0.5,  0.5, 24.0/64.0, 56.0/64,  0.0f,  -1.0f,  0.0f, // 22 Kanan Belakang
		-0.5, -0.5,  0.5, 16.0/64.0, 56.0/64,  0.0f,  -1.0f,  0.0f, // 23 Kiri Belakang
	};
...
void Person::BuildBody() {
	...
	float vertices[] = {
		...
		-0.5, -0.5, 0.5, 20.0 / 64.0, 32.0 / 64.0, 0.0f,  0.0f,  1.0f, // 0  Kiri Bawah
		 ...
		 0.5,  0.5, 0.5, 28.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 2	Kanan Atas
		-0.5,  0.5, 0.5, 20.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 3	Kiri Atas
		...
		0.5,   0.5, -0.5, 40.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 10
		-0.5,  0.5, -0.5, 32.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 11
...
void Person::BuildArms() {
	...
	float vertices[] = {
		...
		-0.5, -0.5, 0.5, 44.0 / 64.0, 32.0 / 64.0, 0.0f,  0.0f,  1.0f, // 0  Kiri Bawah
		 ...
		 0.5,  0.5, 0.5, 48.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 2	Kanan Atas
		-0.5,  0.5, 0.5, 44.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 3	Kiri Atas

		// right
		0.5,  0.5,  0.5, 52.0 / 64.0, 44.0 / 64.0, 1.0f,  0.0f,  0.0f, // 4   Depan Bawah
		0.5,  0.5, -0.5, 48.0 / 64.0, 44.0 / 64.0, 1.0f,  0.0f,  0.0f, // 5	Belakang Bawah
		...
		-0.5, -0.5, -0.5, 52.0 / 64.0, 32.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 8 
		 ...
		 0.5,  0.5, -0.5, 56.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 10
		-0.5,  0.5, -0.5, 52.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 11
		...
		-0.5,  0.5,  0.5,  40.0 / 64.0, 44.0 / 64.0, -1.0f,  0.0f,  0.0f, // 14 Belakang Atas
		-0.5,  0.5, -0.5,  44.0 / 64.0, 44.0 / 64.0, -1.0f,  0.0f,  0.0f, // 15 Depan Atas
...
void Person::BuildLegs() {
	...
	float vertices[] = {
		...
		-0.5, -0.5, 0.5,  4.0 / 64.0, 32.0 / 64.0, 0.0f,  0.0f,  1.0f, // 0  Kiri Bawah
		 ...
		 0.5,  0.5, 0.5,  8.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 2	Kanan Atas
		-0.5,  0.5, 0.5,  4.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  1.0f, // 3	Kiri Atas

		// right
		0.5,  0.5,  0.5,  8.0 / 64.0, 44.0 / 64.0, 1.0f,  0.0f,  0.0f, // 4   Depan Bawah
		0.5,  0.5, -0.5, 12.0 / 64.0, 44.0 / 64.0, 1.0f,  0.0f,  0.0f, // 5	Belakang Bawah
		...
		-0.5, -0.5, -0.5, 12.0 / 64.0, 32.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 8 
		 ...
		 0.5,  0.5, -0.5, 16.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 10
		-0.5,  0.5, -0.5, 12.0 / 64.0, 44.0 / 64.0, 0.0f,  0.0f,  -1.0f, // 11
		...
		-0.5,  0.5,  0.5,  4.0 / 64.0, 44.0 / 64.0, -1.0f,  0.0f,  0.0f, // 14 Belakang Atas
		-0.5,  0.5, -0.5,  0.0 / 64.0, 44.0 / 64.0, -1.0f,  0.0f,  0.0f, // 15 Depan Atas
