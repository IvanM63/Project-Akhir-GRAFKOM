...
void MasterSword::DrawAll() {
	...
	//----------------//
	//bilah Putih
	DrawColoredCube(0, -2.125 /p, 5/p, 0.125/p, 2.0625 /p, 0.0625/p, 0.98039f, 1.00000f, 0.98824f);
	//bilah di atas Putih
	DrawColoredCube(0, -3.1875 /p, 5/p, 0.125/p, 0.125/p, 0.0625/p, 0.79608f, 1.00000f, 0.93333f);

	//Pinggiran kiri
	DrawColoredCube(-0.09375/p, -2.125 /p, 5/p, 0.0625/p, 2.0625 /p, 0.0625/p, 0.79608f, 1.00000f, 0.93333f);
